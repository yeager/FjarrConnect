...
public final class _ObjC_VNCKeyCode: NSObject {
    ...
    @objc
    public static let ansiKeypadClear = X11KeySymbols.XK_Clear // gitleaks:allow -- X11 keysym, not a credential
    @objc
    public static let ansiKeypadEquals = X11KeySymbols.XK_KP_Equal // gitleaks:allow -- X11 keysym, not a credential
    @objc
    public static let ansiKeypadDivide = X11KeySymbols.XK_KP_Divide // gitleaks:allow -- X11 keysym, not a credential
    @objc
    public static let ansiKeypadMultiply = X11KeySymbols.XK_KP_Multiply // gitleaks:allow -- X11 keysym, not a credential
    @objc
    public static let ansiKeypadMinus = X11KeySymbols.XK_KP_Subtract // gitleaks:allow -- X11 keysym, not a credential
    @objc
    public static let ansiKeypadPlus = X11KeySymbols.XK_KP_Add // gitleaks:allow -- X11 keysym, not a credential
    @objc
    public static let ansiKeypadEnter = X11KeySymbols.XK_KP_Enter // gitleaks:allow -- X11 keysym, not a credential
    @objc
    public static let ansiKeypadDecimal = X11KeySymbols.XK_KP_Separator // gitleaks:allow -- X11 keysym, not a credential
