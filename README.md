...
published version (0.2.11), cancelling an upload or download keeps the
...
transfer starts over. Directory uploads and downloads still restart after interruption.
